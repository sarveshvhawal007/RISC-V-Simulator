...
dict = {'lui': {'type': 'UJU'}, 'auipc': {'type': 'UJU'}, 'jal': {'type': 'UJU'}, 'sb': {'type': 'S'}, 'sh': {'type': 'S'}, 'sw': {'type': 'S'}, 'sd': {'type': 'S'}, 'addi': {'type': 'I'}, 'andi': {'type': 'I'}, 'ori': {'type': 'I'}, 'lb': {'type': 'I'}, 'ld': {'type': 'I'}, 'lh': {'type': 'I'}, 'lw': {'type': 'I'}, 'jalr': {'type': 'I'}, 'add': {'type': 'R'}, 'and': {'type': 'R'}, 'or': {'type': 'R'}, 'sll': {'type': 'R'}, 'slt': {'type': 'R'}, 'sra': {'type': 'R'}, 'srl': {'type': 'R'}, 'sub': {'type': 'R'}, 'xor': {'type': 'R'}, 'mul': {'type': 'R'}, 'div': {'type': 'R'}, 'rem': {'type': 'R'}, 'beq': {'type': 'SB'}, 'bne': {'type': 'SB'}, 'blt': {'type': 'SB'}, 'bge': {'type': 'SB'}}
